...
public static class PtnDiagnosisFactCodes
{
    public const string ChallengeScopes = nameof(ChallengeScopes);
    public const string AllowedMethods = nameof(AllowedMethods);
