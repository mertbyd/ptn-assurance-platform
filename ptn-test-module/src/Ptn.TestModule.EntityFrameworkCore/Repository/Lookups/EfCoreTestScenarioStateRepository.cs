...
// islevi: Senaryo yayin durumu lookup'inin EF Core depo uygulamasidir.
...
public class EfCoreTestScenarioStateRepository
    : EfCoreLookupRepository<TestModuleDbContext, TestScenarioState, Guid>, ITestScenarioStateRepository
{
    public EfCoreTestScenarioStateRepository(IDbContextProvider<TestModuleDbContext> dbContextProvider)
