...
// islevi: API checker hipotezinin normalize edilmemis kaynak alanlarini tasir.
// sistemdeki gorevi: Kod ve bulgu referansi kararlarini Manager'a birakir.
public sealed class PtnApiDiagnosisHypothesis
{
    ...
    public List<PtnApiDiagnosisEvidence> Evidence { get; set; } = [];
