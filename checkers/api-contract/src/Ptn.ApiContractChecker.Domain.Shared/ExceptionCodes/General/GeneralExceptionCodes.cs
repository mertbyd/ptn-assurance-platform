...
public static class GeneralExceptionCodes
{
    ...
    private const string Prefix = "ApiContractChecker.General";
    ...
    // Dis bir arama/indeks altyapisi gerektiginde kullanilamazsa donen hata kodu (su an kullanilmiyor).
    ...
    // Korelasyon trace kimligi W3C kucuk harf hex seklinde degilse kullanilan validation kodu.
    public const string CorrelationTraceIdInvalid = "ApiContractChecker.Correlation:Validation:TraceIdInvalid";

    // Korelasyon adim anahtari bos veya izin verilen sinirin disindaysa kullanilan validation kodu.
    public const string CorrelationStepKeyInvalid = "ApiContractChecker.Correlation:Validation:StepKeyInvalid";
}
