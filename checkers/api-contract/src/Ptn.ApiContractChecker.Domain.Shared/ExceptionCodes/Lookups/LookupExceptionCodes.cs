...
{
    private const string Prefix = "ApiContractChecker.Lookup";

    // Ayni Code'a sahip ikinci bir lookup satiri create/seed yoluyla eklenmeye calisildiginda firlatilir.
