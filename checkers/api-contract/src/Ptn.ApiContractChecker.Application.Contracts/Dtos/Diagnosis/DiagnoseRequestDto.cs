...
// islevi: Basarisiz API adiminin snapshot/run referansi ile request-response metadatasini tasir.
// sistemdeki gorevi: Tek diagnosis POST girdisini ham body, token veya serbest probe URL'si olmadan sinirlar.
